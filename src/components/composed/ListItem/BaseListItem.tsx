...
export const BaseListItem = forwardRef<HTMLDivElement, BaseListItemProps>(
  (
    {
      title,
      subtitle,
    ...
    const baseClasses = cn(
      ...
      // 境界線
      conditionalClass(divider, 'border-b border-gray-200'),
      
      // インタラクション
      conditionalClass(clickable, 'cursor-pointer focus:outline-none focus:bg-gray-50'),
      conditionalClass(hoverable || clickable, 'hover:bg-gray-50'),
